package com.capstone2024.scss.infrastructure.configuration.security;

import com.capstone2024.scss.domain.account.enums.Role;
import com.capstone2024.scss.infrastructure.configuration.oauth.google.CustomOAuth2AuthenticationSuccessHandler;
import com.capstone2024.scss.infrastructure.configuration.oauth.google.CustomOAuth2UserService;
import com.capstone2024.scss.infrastructure.configuration.security.authentication.CustomAccessDeniedHandler;
import com.capstone2024.scss.infrastructure.configuration.security.authentication.JwtAuthenticationEntryPoint;
import com.capstone2024.scss.infrastructure.configuration.security.authentication.JwtAuthenticationFilter;
...
//                                .requiresSecure())
                ...
                .authorizeHttpRequests(config ->
                        config.requestMatchers("/topic/**")
                                .permitAll())

                .authorizeHttpRequests(config ->
                        config.requestMatchers("/user/**")
                                .permitAll())
